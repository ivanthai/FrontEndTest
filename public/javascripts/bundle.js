...
/***/ function(module, exports, __webpack_require__) {
	...
	//
	// {/*<li key={user.commit.author.name}>*/}
	// {/*<div className="commit-author">{user.commit.author.name}</div>*/}
	// {/*<div className="commit-message">{user.commit.message}</div>*/}
	// {/*<div className="commit-hash">{user.sha}</div>*/}
	// {/*</li>*/}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!./commitList.css", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!./commitList.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commit = __webpack_require__(190);
	...
	var Commit = function (_React$Component) {
	    ...
	    function Commit(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, (Commit.__proto__ || Object.getPrototypeOf(Commit)).call(this, props));

	        _this.state = {
	            commit: _this.props.body
	        };
	        return _this;
	    }
	    ...
	    _createClass(Commit, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'li',
	                { className: "commit" + (isLastCharNumber(this.state.commit.sha) ? ' lightblue' : '')
	                },
	                _react2.default.createElement(
	                    'div',
	                    null,
	                ...
	                this.state.commit.author ? _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement(
	                        'b',
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { href: 'javascript:void(0)', onClick: this.getUserCommits.bind(this) },
	                        this.state.commit.commit.author.email,
	                        ',  ',
	                        this.state.commit.commit.author.name
	                    )
	                ) : '',
	                _react2.default.createElement(
	                    'a',
	                    { href: this.state.commit.commit.url },
	                    this.state.commit.commit.url
	                )
	            );
	        }
	    }]);
	...
	{/*<div>*/}
	{/*Author: {this.state.commit.commit.author.email},  {this.state.commit.author.name}*/}
	{/*</div>*/}
	{/*<div>*/}
	{/*Message: {this.state.commit.commit.message}*/}
	{/*</div>*/}
	{/*<a href={this.state.commit.commit.url}> Link</a>*/}
